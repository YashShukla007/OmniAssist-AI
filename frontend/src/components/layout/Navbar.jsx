...
function Navbar({ onNotice, onDomainUnavailable }) {
  ...
  function handleSearch(event) {
    if (event.key === "Enter" && event.currentTarget.value.trim()) onNotice(`Search for "${event.currentTarget.value.trim()}" - Feature integrating in the future.`);
  }
